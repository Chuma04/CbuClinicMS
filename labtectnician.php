...
<head>
		...
		<!-- Title -->
		<title>  Home -  lab tectnician </title>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-body">
									...
									<textarea id="mylabreport" name="labresult" class="form-control" placeholder="type report here" ></textarea>
									<br/>
									</div>
					   ...
					   success: function(r)
						  {
							alert(r);
							$("#addModal").modal("hide");
							moveStatus(document.getElementById("openRedcordId").value,1);
							getUsers();
						  },
						 error: function(e) 
						  {
			  ...
			  $.ajax({
			   ...
			   function addReport(id)
			   {
				  ...
				  xhttp.onreadystatechange = function()
				  {
					if (this.readyState == 4 && this.status == 200)
						{
							 document.getElementById('mylabreport').value = this.responseText;
						}
				  };
				  ...
				  xhttp.onreadystatechange = function()
				  {
					if (this.readyState == 4 && this.status == 200)
						{
							 document.getElementById('diagnosisField').innerHTML = this.responseText;
						}
				  };
