							...
							<div class="card overflow-hidden review-project">
								<div class="card-body">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-10">All Students</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
										<button class="btn btn-primary" onClick="addUser()">Add Students</button>
									</div>
									<p class="tx-12 text-muted mb-3">All the  defined students.<a href="#">Learn more</a></p>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">Add Student</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<form id="addForm">
					<div class="modal-body">
									...
									<label>Firstname</label>
										<input id="firstName_edit" name="firstname" class="form-control" placeholder="First Name" type="text">
									</div>
									
									<div class="col-lg">
									<label>Lastname</label>
										<input id="firstName_edit" name="lastname" class="form-control" placeholder="Lastname" type="text">
									</div>
									
									
									<div class="col-lg">
									<label>Studentid</label>
										<input id="firstName_edit" name="studentid" class="form-control" placeholder="Studentid" type="text">
									</div>
									
									<div class="col-lg">
									<label>Address</label>
										<input id="firstName_edit" name="address" class="form-control" placeholder="Address" type="text">
									</div>
									
									<div class="col-lg">
									<label>Age</label>
										<input id="firstName_edit" name="age" class="form-control" placeholder="Age" type="text">
									</div>
									
									<div class="col-lg">
									<label>Phone</label>
										<input id="firstName_edit" name="phone" class="form-control" placeholder="Phone" type="text">
									</div>
			 ...
			 $("#deleteForm").on('submit',(function(e) {
			  ...
			  $.ajax({
			   ...
			   function getUsers()
			   {
				  ...
				  xhttp.open("POST", "ajax.getStudents.php", true);
