			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">Add Vitals</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<form id="addForm">
		  ...
		  $(document).ready(function() {
			 ...
			 $("#addForm").on('submit',(function(e) {
			  ...
			  $.ajax({
					   ...
					   success: function(r)
						  {
							alert(r);
							moveStatus(document.getElementById("openRedcordId").value,document.getElementById("openRedcordStatus").value);
							$("#addModal").modal("hide");
							getUsers();
						  },
						 error: function(e) 
			 ...
			 $("#deleteForm").on('submit',(function(e) {
			  ...
			  $.ajax({
			   ...
			   function addVital(id,status)
			   {
				   
				   document.getElementById("openRedcordId").value = id;
				   document.getElementById("openRedcordStatus").value = status;
				   $("#addModal").modal();
